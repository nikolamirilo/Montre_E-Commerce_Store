      ...
      <div className="min-h-screen bg-white py-20 h-fit">
        ...
        <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
            ...
            <div className="justify-between mb-6 rounded-lg bg-white p-6 shadow-md sm:flex sm:justify-start">
              ...
              <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                <div className="mt-5 sm:mt-0">
                  ...
                  <p className="mt-1 text-xs text-gray-700">Size: 38EU</p>
                </div>
          ...
          <div className="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3">
            ...
            <button className="mt-6 w-full rounded-md bg-amber-500 py-1.5 font-medium text-amber-50 hover:bg-amber-600">
              Check out
            </button>
          </div>
        </div>
