  ...
  return (
    <div className="relative flex flex-col justify-center items-center gap-2 md:fle md:flex-row md:justify-center lg:justify-start">
      <button
        ...
        id="man-offer"
        className="romboid bg-white p-4 border-none h-56 relative md:left-10 lg:left-12 xl:left-16 w-full md:w-1/2  font-bold py-2 px-4 inline-flex items-center gap-2 shadow-xl shadow-black/20">
        <Image
      ...
      <button
        ...
        id="woman-offer"
        className="romboid-reverse bg-white p-4 border-none h-56 relative md:right-10 lg:right-12  xl:right-16 w-full md:w-1/2 font-bold py-2 px-4 inline-flex items-center gap-2  shadow-xl shadow-amber-600/20">
        <Image
