  ...
  return (
    <>
      ...
      <div className="max-w-xl">
        <div className="bg-white shadow-xl rounded-lg max-w-lg relative lg:hover:scale-[1.02] transition-all duration-200 ease-in-out">
          ...
          <div
            className="relative w-72 h-72 xl:w-80 xl:h-80 2xl:w-[22rem] 2xl:h-[22rem]  cursor-pointer rounded-xl"
            onClick={() => {
              router.push(`/products/watches/${productCode}`)
            }}>
            <Image
              className="py-5 px-4 object-cover object-center"
              fill
              src={image}
              alt={title}
              loading="lazy"
          ...
          <div className="px-4 pb-2">
            ...
            <div
              className={`flex items-center justify-between  ${isOnDiscount == false && "mb-3"}`}>
              ...
              {user != null ? (
                ...
                <Link
                  ...
                  className={`text-white z-10 bg-amber-500 hover:bg-amber-600 rounded-lg px-2.5 py-2 text-center flex-row gap-1 justify-center items-center ${
                    isOutOfStock == true ? "hidden" : "flex"
                  }`}>
